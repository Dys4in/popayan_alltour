...
class VisitaEstablecimiento(models.Model):
    """Modelo para registrar las visitas a los establecimientos"""
    # Relacionar con cualquier tipo de establecimiento
    content_type = models.ForeignKey(
        'contenttypes.ContentType', 
        on_delete=models.CASCADE
    )
    object_id = models.PositiveIntegerField()
    establecimiento = GenericForeignKey('content_type', 'object_id')
    ...
    def __str__(self):
        return f"Visita el {self.fecha_visita.strftime('%Y-%m-%d %H:%M')}"
